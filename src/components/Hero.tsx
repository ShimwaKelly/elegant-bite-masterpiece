...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[500px] sm:min-h-[600px] md:h-screen w-full overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative h-full flex flex-col justify-center items-center text-center px-4 md:px-8 py-16 md:py-0">
        <p 
          ref={subtitleRef}
        ...
        <h1 
          ref={titleRef}
          className="font-playfair font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-white max-w-4xl opacity-0 -translate-y-6 transition-all duration-700 mb-4 md:mb-6 leading-tight"
        >
        ...
        <div 
          ref={ctaRef}
          className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 opacity-0 translate-y-6 transition-all duration-700 w-full max-w-md sm:max-w-none"
        >
          <Link 
            to="/reservation" 
